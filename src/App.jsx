    ...
    <div style={{...S.app,display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{width:"100%",maxWidth:420,padding:24}}>
        <div style={{textAlign:"center",marginBottom:36}}>
          ...
          <h1 style={{fontSize:32,fontWeight:900,background:"linear-gradient(135deg,#3b82f6,#8b5cf6)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",margin:0}}>RheumUSU</h1>
          <p style={{color:"#64748b",margin:"8px 0 0",fontSize:13}}>Divisi Reumatologi · FK-USU / RSUP H. Adam Malik</p>
        </div>
        <div style={S.card}>
      ...
      <div style={{background:"#1e293b",borderBottom:"1px solid #334155",padding:"0 20px"}}>
        <div style={{maxWidth:1200,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",height:60}}>
          <div style={{display:"flex",alignItems:"center",gap:12}}>
            ...
            <div><div style={{fontWeight:900,fontSize:17,background:"linear-gradient(135deg,#3b82f6,#8b5cf6)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>RheumUSU</div><div style={{color:"#64748b",fontSize:10}}>PPDS Reumatologi · FK-USU</div></div>
          </div>
          <div style={{display:"flex",alignItems:"center",gap:12}}>
